window.addEventListener('load' , function(){
    ...
    let inputhijos3madre = document.getElementById('inputhijos3madre')
  ...
  function addEjemplarGanador3(nombre , padre , sexo, cant3 ,puesto3, nombreCsEspeciales3 ){
   ...
   //  alert(JSON.stringify(puesto1) + nombreEjemplar)
    ...
    let grupos3 = puesto3G.filter((item,index)=>{
        ...
        hijos3madre.appendChild(addEjemplarGanador123Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2,  cantPuesto3, grupos3, nombreCsEsp3 ));
        ...
        hijos3madre.appendChild(addEjemplarGanador12(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2 ));
            ...
            hijos3madre.appendChild(addEjemplarGanador12Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2 ));
            ...
            hijos3madre.appendChild(addEjemplarGanador1Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1));
            ...
            hijos3madre.appendChild(addEjemplarGanador13Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1,  cantPuesto3, grupos3, nombreCsEsp3 ));
