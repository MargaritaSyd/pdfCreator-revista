window.addEventListener('load' , function(){
    ...
    inputhijos5madre =  document.getElementById('inputhijos5madre')
...
///UNA VEZ QUE SACO EL ID DE LA ABUELA PUEDO SACAR INFO DE LOS HIJOS DE 3MADRE (HERMANOS DE LA ABUELA)
   ...
   //     alert(JSON.stringify(data.data))
    ...
    let grupos3 = puesto3G.filter((item,index)=>{
        ...
        hijos5madre.appendChild(addEjemplarGanador123Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2,  cantPuesto3, grupos3, nombreCsEsp3 ));
        ...
        hijos5madre.appendChild(addEjemplarGanador12(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2 ));
            ...
            hijos5madre.appendChild(addEjemplarGanador12Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2 ));
            ...
            hijos5madre.appendChild(addEjemplarGanador1Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1));
            ...
            hijos5madre.appendChild(addEjemplarGanador13Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1,  cantPuesto3, grupos3, nombreCsEsp3 ));
    ...
    inputhijos5madre.value = hijos5madre.textContent
