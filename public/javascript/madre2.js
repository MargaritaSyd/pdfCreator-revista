window.addEventListener('load' , function(){
    ...
    let inputhijos2madre = document.getElementById('inputhijos2madre')
  ...
  //   alert(JSON.stringify(puesto1) + nombreEjemplar)
    ...
    let grupos3 = puesto3G.filter((item,index)=>{
        ...
        if(cantPuesto1 != 0 && cantPuesto2 != 0 && cantPuesto3 != 0 && cantGrupo1 == 0){
            hijos2madre.appendChild(addEjemplarGanador123(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2,  cantPuesto3, grupos3, nombreCsEsp3 ));
      
          
      }  else if(cantPuesto1 != 0 && cantPuesto2 != 0 && cantPuesto3 != 0 && cantGrupo1 != 0){
        hijos2madre.appendChild(addEjemplarGanador123Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2,  cantPuesto3, grupos3, nombreCsEsp3 ));
  
      
     }  else if( cantPuesto1 != 0 && cantPuesto2 != 0 && cantPuesto3 == 0 && cantGrupo1 == 0){
       
        hijos2madre.appendChild(addEjemplarGanador12(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2 ));
      
        }
        else if( cantPuesto1 != 0 && cantPuesto2 != 0 && cantPuesto3 == 0 && cantGrupo1 != 0){
       
            hijos2madre.appendChild(addEjemplarGanador12Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1, cantPuesto2, grupos2, nombreCsEsp2 ));
          
            }
        else if( cantPuesto1 != 0 && cantPuesto2 == 0 && cantPuesto3 == 0 && cantGrupo1 == 0){
            hijos2madre.appendChild(addEjemplarGanador1(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1));
      
          }  else if( cantPuesto1 != 0 && cantPuesto2 == 0 && cantPuesto3 == 0 && cantGrupo1 != 0){
            hijos2madre.appendChild(addEjemplarGanador1Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1));
      
          }
          else if( cantPuesto1 != 0 && cantPuesto2 == 0 && cantPuesto3 != 0 && cantGrupo1 == 0){
            hijos2madre.appendChild(addEjemplarGanador13(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1,  cantPuesto3, grupos3, nombreCsEsp3 ));
      
        
        }
        else if( cantPuesto1 != 0 && cantPuesto2 == 0 && cantPuesto3 != 0 && cantGrupo1 != 0){
            hijos2madre.appendChild(addEjemplarGanador13Especial(nombreEjemplar, padre, sexo, cantPuesto1 , hipodromos1, grupo1, nombreCsEsp1,  cantPuesto3, grupos3, nombreCsEsp3 ));
      
        
        } else if( cantPuesto1 == 0 && cantPuesto2 != 0 && cantPuesto3 != 0){
            hijos2madre.appendChild(addEjemplarGanador23(nombreEjemplar, padre, sexo, cantPuesto2, grupos2, nombreCsEsp2,  cantPuesto3, grupos3, nombreCsEsp3 ));
      
        
        } else if( cantPuesto1 == 0 && cantPuesto2 != 0 && cantPuesto3 == 0){
            hijos2madre.appendChild(addEjemplarGanador2(nombreEjemplar, padre, sexo, cantPuesto2, grupos2, nombreCsEsp2 ));
      
      
        } else if( cantPuesto1 == 0 && cantPuesto2 == 0 && cantPuesto3 != 0){
            hijos2madre.appendChild(addEjemplarGanador3(nombreEjemplar, padre, sexo, cantPuesto3, grupos3, nombreCsEsp3 ));
      
        } else if( cantPuesto1 == 0 && cantPuesto2 == 0 && cantPuesto3 == 0){
            hijos2madre.appendChild(addEjemplarGanador0(nombreEjemplar, padre, sexo));
